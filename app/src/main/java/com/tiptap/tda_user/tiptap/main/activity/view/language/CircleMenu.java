...
public class CircleMenu extends View{
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //************************ taghiire size Icon va fasele dayereha**********************

        partSize = minSize / 13;
        iconSize = partSize * 10 / 6;
        circleMenuRadius = partSize * 4;
    ...
    private void drawCirclePath(Canvas canvas) {
        ...
        //*************** Entekhaaabe pahnaie charkheshe Icon ***************//
        cPaint.setStrokeWidth(partSize * 3);
    ...
    private void drawSubMenu(Canvas canvas) {
        ...
        for (int i = 0; i < itemNum; i++) {
            ...
            if (status == STATUS_MENU_OPEN) {
                itemX = (int) (centerX + Math.sin(Math.toRadians(angle + 45)) * (circleMenuRadius - (1 - fraction) * partSize * offsetRadius));
                itemY = (int) (centerY - Math.cos(Math.toRadians(angle + 45)) * (circleMenuRadius - (1 - fraction) * partSize * offsetRadius));
                ...
                itemX = (int) (centerX + Math.sin(Math.toRadians(angle + 45)) * (circleMenuRadius - fraction * partSize * offsetRadius));
                itemY = (int) (centerY - Math.cos(Math.toRadians(angle + 45)) * (circleMenuRadius - fraction * partSize * offsetRadius));
                oPaint.setColor(calcAlphaColor(subMenuColorList.get(i), true));
                sPaint.setColor(calcAlphaColor(subMenuColorList.get(i), true));

            } else {
                itemX = (int) (centerX + Math.sin(Math.toRadians(angle + 45)) * circleMenuRadius);
                itemY = (int) (centerY - Math.cos(Math.toRadians(angle + 45)) * circleMenuRadius);
